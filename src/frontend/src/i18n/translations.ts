...
export const translations = {
  zh: {
    ...
    templateLabel: "簡報模板（選填）",
    templateHint: "上傳 PPTX 可套用其母片、版型與主題；未上傳時使用系統預設模板。",
    templateError: "簡報模板僅接受 PPTX 格式",
    templateSelectButton: "選擇模板",
    templateRemove: "移除模板",
    promptLabel: "提示詞",
  ...
  en: {
    ...
    templateLabel: "Presentation Template (optional)",
    templateHint: "Upload a PPTX to use its masters, layouts, and theme. The default template is used when omitted.",
    templateError: "Only PPTX presentation templates are accepted",
    templateSelectButton: "Choose Template",
